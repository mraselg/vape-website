...
<?php
    ...
    if (!empty($VCD_SEO['google_verification_code'])) {
        $gCode = trim((string) $VCD_SEO['google_verification_code']);
        if (str_starts_with($gCode, '<meta')) {
            echo "  " . $gCode . "\n";
        } else {
            echo '  <meta name="google-site-verification" content="' . e($gCode) . "\">\n";
        }
    }

    // Google Tag Manager (GTM in <head>)
    if (!empty($VCD_SEO['gtm_id'])) {
        $gtm = e(trim((string) $VCD_SEO['gtm_id']));
    ...
    if (!empty($VCD_SEO['ga4_id'])) {
        $ga4 = e(trim((string) $VCD_SEO['ga4_id']));
    ...
    // Facebook / Meta Pixel
    if (!empty($VCD_SEO['facebook_pixel_id'])) {
        $fbPixel = e(trim((string) $VCD_SEO['facebook_pixel_id']));
        ...
        echo "  <noscript><img height=\"1\" width=\"1\" style=\"display:none\" src=\"https://www.facebook.com/tr?id={$fbPixel}&ev=PageView&noscript=1\"/></noscript>\n";
        echo "  <!-- End Meta Pixel Code -->\n";
    }

    // TikTok Pixel
    if (!empty($VCD_SEO['tiktok_pixel_id'])) {
        $ttPixel = e(trim((string) $VCD_SEO['tiktok_pixel_id']));
        echo "  <!-- TikTok Pixel Code -->\n";
        echo "  <script>!function (w, d, t) { w.TiktokAnalyticsObject=t;var ttq=w[t]=w[t]||[];ttq.methods=['page','track','identify','instances','debug','on','off','once','ready','alias','group','enableCookie','disableCookie'],ttq.setAndDefer=function(t,e){t[e]=function(){t.push([e].concat(Array.prototype.slice.call(arguments,0)))}};for(var i=0;i<ttq.methods.length;i++)ttq.setAndDefer(ttq,ttq.methods[i]);ttq.instance=function(t){for(var e=ttq._i[t]||[],n=0;n<ttq.methods.length;n++)ttq.setAndDefer(e,ttq.methods[n]);return e};ttq.load=function(e,n){var i='https://analytics.tiktok.com/i18n/pixel/events.js';ttq._i=ttq._i||{},ttq._i[e]=[],ttq._i[e]._u=i,ttq._t=ttq._t||{},ttq._t[e]=+new Date,ttq._o=ttq._o||{},ttq._o[e]=n||{};var o=document.createElement('script');o.type='text/javascript',o.async=!0,o.src=i+'?sdkid='+e+'&lib='+t;var a=document.getElementsByTagName('script')[0];a.parentNode.insertBefore(o,a)};ttq.load('{$ttPixel}');ttq.page();}(window, document, 'ttq');</script>\n";
        echo "  <!-- End TikTok Pixel Code -->\n";
    }

    // Custom Extra Head Code (Meta tags, verification scripts, etc.)
...
function render_vcd_script(): void
{
    ...
    // Custom Extra Body Code (Conversion scripts, live chat widgets)
    $extraBody = (string) ($VCD_SEO['extra_body_code'] ?? '');
    if ($extraBody !== '') {
        echo $extraBody . "\n";
    }
}
